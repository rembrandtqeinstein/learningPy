...
end = datetime.datetime.strptime("18-07-2020", "%d-%m-%Y")
...
# From the 7 of July onwards Oral check
...
temp = [35.3, 35.3, 35.8, 35.5, 35.6, 35.2, 35.4, 35.7, 35, 35.7, 36.1, 35.8, 35.8, 35.3, 35.3,
        ...
        36.1,35.9, 35.7, 35.2, 35.9, 34.9, 35.7, 35.9, 36.0, 35.7, 35.8, 36.3, 36.2, 35.8, 36.3, 35.5, 36.4, 35.7, 36.6, 36.5, 36.3, 36.8, 36.1, 35.6, 36.4, 36.6, 36.4, 36.0]
